...
use Rock\Swoole\Http\WebSocketParser;
class WebSocket
{
    const VERSION = '0.1.4';
     ...
     */
    public function __construct(WebSocketParser $webSocketParser)
    {
        $this->webSocketParser = $webSocketParser;
    }

    public function swoole_socket($host, $port = 80, $path ='/', WebSocketParser $webSocketParser)
    {
        if(empty($host))
        {
